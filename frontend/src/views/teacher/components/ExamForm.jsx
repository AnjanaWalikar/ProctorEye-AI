  ...
  return (
    <>
      ...
      <Box component="form">
        ...
        {/* Show coding question section only for 'coding' or 'both' exam types */}
        {(values.examType === 'coding' || values.examType === 'both') && (
